...
describe('virtual scroll based nzChildrenAccessor', () => {
  ...
  describe('basic', () => {
    let fixture: ComponentFixture<TriTestTreeViewVirtualScrollWithChildrenAccessorComponent>;
    let testComponent: TriTestTreeViewVirtualScrollWithChildrenAccessorComponent;
    let tree: TriTreeVirtualScrollViewComponent<TreeNode>;
    let viewport: CdkVirtualScrollViewport;

    beforeEach(() => {
      fixture = TestBed.createComponent(TriTestTreeViewVirtualScrollWithChildrenAccessorComponent);
