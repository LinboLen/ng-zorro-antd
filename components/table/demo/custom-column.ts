...
@Component({
  ...
  template: `
    ...
    <tri-modal [visible]="isVisible()" title="Custom Column" (onCancel)="handleCancel()" (onOk)="handleOk()">
              ...
              >
                @for (item of fix(); track item) {
                  <div class="example-box" cdkDrag>
                    {{ item.name }}
                    <tri-icon type="minus-circle" theme="outline" (click)="deleteCustom(item, $index)" />
                  </div>
                }
              </div>
            ...
            <div class="example-container">
              ...
              >
                @for (item of notFix(); track item) {
                  <div class="example-box" cdkDrag>
                    {{ item.name }}
                    <tri-icon type="plus-circle" theme="outline" (click)="addCustom(item, $index)" />
                  </div>
                }
              </div>
            </div>
