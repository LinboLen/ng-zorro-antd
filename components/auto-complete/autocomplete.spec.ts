...
describe('auto-complete', () => {
  ...
  describe('property', () => {
    ...
    let component: TriTestAutocompletePropertyComponent;
    let input: HTMLInputElement;
  ...
  describe('value', () => {
    let fixture: ComponentFixture<TriTestSimpleAutocompleteComponent>;
    let component: TriTestSimpleAutocompleteComponent;
    let input: HTMLInputElement;
  ...
  describe('form', () => {
    ...
    let componentInstance: TriTestAutocompleteWithFormComponent;
    let input: HTMLInputElement;
    ...
    it('should set correct label', async () => {
      const fixture = TestBed.createComponent(TriTestAutocompleteDifferentValueWithFormComponent);
      fixture.detectChanges();
      await fixture.whenStable();
...
@Component({
  ...
  template: `
    <input [ngModel]="inputValue" (ngModelChange)="inputValue = $event" [autocomplete]="auto" />
    <tri-autocomplete
      [width]="width()"
...
@Component({
  imports: [FormsModule, TriAutocompleteModule],
  template: `
    <input [autocomplete]="auto" [ngModel]="inputValue" (ngModelChange)="inputValue = $event" />
    <tri-autocomplete #auto>
