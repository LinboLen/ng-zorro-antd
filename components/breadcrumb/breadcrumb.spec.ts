...
@Component({
  imports: [RouterOutlet, TriBreadCrumbModule],
  template: `
    <tri-breadcrumb [autoGenerate]="true" routeLabel="customBreadcrumb" />
    <router-outlet />
  `
})
...
@Component({
  imports: [RouterOutlet, TriBreadCrumbModule],
  template: `
    <tri-breadcrumb [autoGenerate]="true" routeLabel="customBreadcrumb" [routeLabelFn]="labelFn" />
    <router-outlet />
  `
})
...
@Component({
  imports: [RouterOutlet, TriBreadCrumbModule],
  template: `
    <tri-breadcrumb [autoGenerate]="true" routeLabel="customBreadcrumb" [routeFn]="routeFn" />
    <router-outlet />
  `
})
