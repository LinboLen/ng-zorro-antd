...
describe('breadcrumb', () => {
  ...
  testDirectionality(() => TriDemoBreadcrumbBasicComponent, By.directive(TriBreadCrumbComponent), 'ant-breadcrumb');
});

async function stabilize(fixture: ComponentFixture<TriSafeAny>): Promise<void> {
  fixture.detectChanges();
...
@Component({
  imports: [RouterOutlet, TriBreadCrumbModule],
  template: `
    <tri-breadcrumb autoGenerate routeLabel="customBreadcrumb" />
    <router-outlet />
  `
})
...
@Component({
  imports: [RouterOutlet, TriBreadCrumbModule],
  template: `
    <tri-breadcrumb autoGenerate routeLabel="customBreadcrumb" [routeLabelFn]="labelFn" />
    <router-outlet />
  `
})
...
@Component({
  imports: [RouterOutlet, TriBreadCrumbModule],
  template: `
    <tri-breadcrumb autoGenerate routeLabel="customBreadcrumb" [routeFn]="routeFn" />
    <router-outlet />
  `
})
...
@Component({
  ...
  template: '<tri-breadcrumb [autoGenerate]="true" />'
})
...
describe('breadcrumb', () => {
  ...
  it('should have correct value for nextUrl', () => {
    ...
    component['getBreadcrumbs'](mockRoute as TriSafeAny, 'mockUrl', []);
