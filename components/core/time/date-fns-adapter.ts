...
export interface TriDateFnsAdapterConfig extends TriDateAdapterConfig<Locale> {
...
export class DateFnsDateAdapter extends TriDateAdapter<Date, Locale> {
  ...
  override parseTime(value: TriSafeAny, parseFormat?: TriSafeAny): Date | null {
