...
import { TriDateAdapter } from './date-adapter';
import { TRI_DATE_LOCALE } from './date-config';
...
describe('DateFnsDateAdapter', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [provideNzDateFnsAdapter(), { provide: TRI_DATE_LOCALE, useValue: enUS }]
    });
    adapter = TestBed.inject(TriDateAdapter) as DateFnsDateAdapter;
  });
  ...
  describe('root provider', () => {
    it('should provide date-fns adapter at application root', () => {
      ...
      expect(TestBed.inject(TriDateAdapter)).toBeInstanceOf(DateFnsDateAdapter);
      expect(TestBed.inject(TriDateAdapter)).toBe(TestBed.inject(DateFnsDateAdapter));
    });
    ...
    it('should use the root adapter when another adapter is provided', () => {
      ...
      expect(TestBed.inject(TriDateAdapter)).toBeInstanceOf(NativeDateAdapter);
    });
    ...
    it('should configure locale from provideNzDateFnsAdapter', () => {
      ...
      const a = TestBed.inject(TriDateAdapter) as DateFnsDateAdapter;
  ...
  describe('format', () => {
    ...
    it('should return empty string for null-like date', () => {
      expect(adapter.format(null as TriSafeAny, 'yyyy-MM-dd')).toBe('');
    });
