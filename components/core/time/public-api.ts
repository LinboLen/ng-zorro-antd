...
export type { TriDateFnsAdapterConfig, TriDateFnsAdapterConfigFactory } from './date-fns-adapter';
export { NativeDateAdapter, provideNzNativeDateAdapter } from './native-adapter';
export type { TriNativeDateAdapterConfig, TriNativeDateAdapterConfigFactory } from './native-adapter';
