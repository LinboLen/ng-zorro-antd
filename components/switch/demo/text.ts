...
@Component({
  ...
  template: `
    <tri-switch [ngModel]="true" checkedChildren="开" unCheckedChildren="关" />
    <br />
    <br />
    <tri-switch [ngModel]="false" checkedChildren="1" unCheckedChildren="0" />
    <br />
    <br />
    <tri-switch [ngModel]="true" [checkedChildren]="checkedTemplate" [unCheckedChildren]="unCheckedTemplate" />
