...
import { TriShowUploadList, TriUploadFile, TriUploadListType } from './interface';
  ...
  describe('basic', () => {
    ...
    describe('[icons]', () => {
      ...
      it('should show remove icon only for files matching function predicate', () => {
        instance.icons.set({
          showPreviewIcon: false,
          showRemoveIcon: (file: TriUploadFile) => file.status === 'done'
        });
        fixture.detectChanges();
      ...
      it('should show preview icon only for files matching function predicate', () => {
        instance.icons.set({
          showPreviewIcon: (file: TriUploadFile) => file.status === 'done',
          showRemoveIcon: false
        });
        fixture.detectChanges();
      ...
      it('should show download icon only for files matching function predicate', () => {
        instance.icons.set({
          showPreviewIcon: false,
          showRemoveIcon: false,
          showDownloadIcon: (file: TriUploadFile) => file.name === 'xxx.png'
        });
        fixture.detectChanges();
...
@Component({
  selector: 'tri-test-upload-list-with-template',
...
class TestUploadListWithTemplateComponent {
  readonly removeIconTpl = viewChild.required<TemplateRef<{ $implicit: TriUploadFile }>>('removeIcon');
  readonly downloadIconTpl = viewChild.required<TemplateRef<{ $implicit: TriUploadFile }>>('downloadIcon');
  readonly previewIconTpl = viewChild.required<TemplateRef<{ $implicit: TriUploadFile }>>('previewIcon');
  readonly extraTpl = viewChild.required<TemplateRef<{ $implicit: TriUploadFile }>>('extra');
