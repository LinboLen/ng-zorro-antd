...
@Component({
  ...
  template: `
    <div class="description">
      <tri-float-button icon="file-text" description="HELP" shape="square" style="right: 24px"></tri-float-button>
      <tri-float-button description="HELP" shape="square" style="right: 94px"></tri-float-button>
    </div>
  `,
  styles: [
    `
