...
describe('nz-float-button-top', () => {
  describe('basic', () => {
    ...
    beforeEach(() => {
      ...
      scrollService = TestBed.inject(TriScrollService) as TriSafeAny;
    });
  ...
  testDirectionality(() => TestFloatButtonTopComponent, By.directive(TriFloatButtonTopComponent), 'ant-float-btn');

  describe('animation', () => {
    it('should have correct animation classes', () => {
      const fixture = TestBed.createComponent(TriFloatButtonTopComponent);
