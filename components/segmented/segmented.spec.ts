...
describe('segmented', () => {
  ...
  testDirectionality(() => TriSegmentedTestComponent, By.directive(TriSegmentedComponent), 'ant-segmented');

  describe('DOM structure', () => {
    let fixture: ComponentFixture<TriSegmentedDomStructureTestComponent>;

    beforeEach(() => {
      fixture = TestBed.createComponent(TriSegmentedDomStructureTestComponent);
      fixture.detectChanges();
    });
...
describe('segmented animation', () => {
  ...
  it('should not render thumb element if not in animation', async () => {
    await fixture.whenStable();
    const segmentedComponentInstance = fixture.debugElement.query(By.directive(TriSegmentedComponent)).componentInstance;
...
export class TriSegmentedTestComponent {
  ...
  readonly options = signal<TriSegmentedOptions>([1, 2, 3]);
