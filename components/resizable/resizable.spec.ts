...
describe('resizable', () => {
  ...
  beforeEach(fakeAsync(() => {
    ...
    [
      TriDemoResizableBasicComponent,
      TriDemoResizableCustomizeComponent,
      TriDemoResizableGridComponent,
      TriDemoResizableLockAspectRatioComponent,
      TriDemoResizablePreviewComponent
    ].forEach(comp => {
