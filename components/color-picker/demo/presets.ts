...
import { TriColorPickerModule, TriPresetColor } from 'ng-zorro-antd/color-picker';

@Component({
  selector: 'tri-demo-color-picker-presets',
...
export class TriDemoColorPickerPresetsComponent {
  basicPresets: TriPresetColor[] = [
    {
      label: 'Recommended',
      colors: [
        '#000000',
  ...
  multiplePresets: TriPresetColor[] = [
    {
