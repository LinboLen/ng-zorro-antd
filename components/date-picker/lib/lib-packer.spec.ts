...
import { CandyDate, NativeDateAdapter, TriDateAdapter, provideNzDateAdapter } from 'ng-zorro-antd/core/time';
import { TriSafeAny } from 'ng-zorro-antd/core/types';
import { en_US, TriI18nModule } from 'ng-zorro-antd/i18n';
...
class TuesdayStartDateAdapter extends NativeDateAdapter {
  ...
  override format(date: Date, displayFormat: TriSafeAny): string {
    if (displayFormat === 'E') {
...
describe('Coverage supplements', () => {
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [LibPackerModule, TriI18nModule],
  ...
  describe('DateTable', () => {
    ...
    it('should configure custom adapter provider', () => {
      ...
      componentInstance = TestBed.createComponent(DateTableComponent).componentInstance;
      componentInstance.activeDate = new CandyDate(new Date(2024, 5, 15));
      const dateAdapter = TestBed.inject(TriDateAdapter);
