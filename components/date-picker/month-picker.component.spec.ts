...
describe('month-picker', () => {
  ...
  describe('general api testing', () => {
    ...
    it('should support nzLocale', () => {
      ...
      fixtureInstance.locale.set({
        lang: { monthPlaceholder: featureKey } as unknown as TriDatePickerLangI18nInterface,
        timePickerLocale: {}
      });
      fixture.detectChanges();
  ...
  describe('specified date picker testing', () => {
    ...
    it('should support nzRenderExtraFooter', async () => {
      ...
      fixture.detectChanges();
      expect(
        overlayContainerElement.textContent!.indexOf(fixtureInstance.renderExtraFooter() as string) > -1
      ).toBeTruthy();
    });
