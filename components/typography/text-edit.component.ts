...
@Component({
  ...
  imports: [CdkTextareaAutosize, TriInputModule, TriTransButtonModule, TriIconModule, TriTooltipModule, TriOutletModule],
  template: `
    @if (editing) {
      <textarea #textarea tri-input cdkTextareaAutosize (blur)="confirm()"></textarea>
