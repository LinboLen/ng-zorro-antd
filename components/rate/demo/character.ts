...
@Component({
  ...
  template: `
    <tri-rate [ngModel]="0" allowHalf [character]="characterIcon" />
    <br />
    <tri-rate [ngModel]="0" allowHalf class="large" [character]="characterEnLetter" />
    <br />
    <tri-rate [ngModel]="0" allowHalf [character]="characterZhLetter" />
