...
import { TriTabPositionMode, type TriIndicator, type TriIndicatorAlign } from './interfaces';
...
export class TriTabsInkBarDirective {
  ...
  private setIndicatorPosition(element: HTMLElement, align: TriIndicatorAlign = 'start'): string {
    ...
    const resolvedAlign: TriIndicatorAlign = isRtl && align !== 'center' ? (align === 'start' ? 'end' : 'start') : align;
